  ...
  return (
    <div>
      <ExplanationBox title="One Prediction Is Not a Sentence">
        ...
        <p>
          The answer is the promise from the very first step — guess a word, add it on, guess the next.
          The proper name is <strong>autoregression</strong>: run the exact same machine over and over,
          and each word the model produces becomes part of the input for the next run. The output feeds
          back into the input. That feedback loop is the entire trick to generating text.
        </p>
      </ExplanationBox>
      ...
      <ExplanationBox title="That Is the Whole Forward Story">
        <p>
          ...
          that make &ldquo;blue&rdquo; come out on top, actually come from? That is <strong>training</strong> —
          and it is next. First on the smallest piece of the machine, the embedding table, with every
          algorithm in the open; then unleashed on all of it.
        </p>
      </ExplanationBox>
    </div>
  );
