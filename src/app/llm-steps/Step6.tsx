  ...
  return (
    <div>
      ...
      <WorkedExample title="Computing the Query for &ldquo;is&rdquo;">
        <p>
          Let&apos;s do it with real numbers. A real W_Q is trained — carved by gradient descent, never
          written by a person. To follow the arithmetic by hand we need concrete
          numbers, so we hand-pick a W_Q that does the kind of job training lands on:{' '}
          <code>[[0, 0, 2], [1, 0, 0], [0, 0, 0]]</code>. The embedding for &ldquo;is&rdquo; is{' '}
