    ...
    <div>
      ...
      <WorkedExample title="Running Our Vector Through a Tiny FFN">
        <p>
          ...
          and — same disclosure as always — real W<sub>1</sub>/W<sub>2</sub> weights are trained by the
          gradient loop, not written by anyone; ours are hand-picked so you can read what each row does.
          Every <em>operation</em> is the real thing. Input{' '}
