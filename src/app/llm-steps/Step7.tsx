    ...
    <div>
      <ExplanationBox title="The Score Is Just a Dot Product">
        ...
        <p>
          ...
          vectors line up&rdquo; — the <strong>dot product</strong> from the vectors step. That is the entire
          scoring rule:
        </p>
      ...
      <ExplanationBox title="See the Gap">
        <ScoreBars />
        <p>
          This is the moment attention earns its name. A few steps back we found that &ldquo;The&rdquo; and
          &ldquo;is&rdquo; had the highest dot product of all (<strong>0.73</strong>) — nearly identical as
          raw vectors — which was useless for prediction. The learned query matrix fixed that: by reshaping
