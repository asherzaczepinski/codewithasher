    ...
    <div>
      ...
      <ExplanationBox title="Measuring the Error: Loss as Surprise">
        <p>
          ...
          squared. For next-word prediction, the standard loss is <strong>cross-entropy</strong> — an old
          friend by now: it is exactly what you used to train the embedding table in the last step, and this
          time it grades the <em>whole machine</em>. After the softmax, the model has handed some
          probability to the word that <em>actually</em> came next. The loss simply measures{' '}
      ...
      <ExplanationBox title="Now Multiply by a Trillion">
        ...
        <p>
          ...
          the forward pass of a finished network, exactly the generation loop from the generation step. But a
