    ...
    <div>
      ...
      <ExplanationBox title="The Unembedding: A Vector for Every Word">
        ...
        <p>
          ...
          plausible candidates instead of all 50,000, with hand-picked toy output vectors standing in for
          trained ones (in a real GPT these are weights, sculpted by the same gradient loop as everything
          else). The real model does the exact same dot product, just 50,000 times.
        </p>
      </ExplanationBox>
