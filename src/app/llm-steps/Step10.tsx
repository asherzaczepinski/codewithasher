  ...
  return (
    <div>
      ...
      <ExplanationBox title="This Is the Bank / Riverbank Fix, in Real Numbers">
        <p>
          Back at the start of this part we raised the problem: a fixed embedding cannot tell a <em>river bank</em>{' '}
        ...
        <p>
          This context vector — <code>[0.72, 0.52, 0.26]</code> — is the payload attention produces, and
          it is our headline number from here on: every remaining stage of the machine works on this
          vector, all the way to the final prediction. Hold onto it.
        </p>
      </ExplanationBox>
    </div>
  );
