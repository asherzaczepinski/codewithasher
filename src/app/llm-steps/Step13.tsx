  ...
  return (
    <div>
      ...
      <ExplanationBox title="The Full Block">
        ...
        <p>
          The block is built. But there are two things we quietly skipped: nothing in it knows what{' '}
          <em>order</em> the words came in, and one block is never enough. Both fixes are next.
        </p>
      </ExplanationBox>
    </div>
  );
