    ...
    <div>
      ...
      <ExplanationBox title="Variance Along an Arbitrary Direction">
        ...
        <p>
          ...
          component</strong>. Everything in the next few modules is about finding it. The
          key tool we need first is understanding how two features vary <em>together</em>:
          that&apos;s covariance.
        </p>
      </ExplanationBox>
    </div>
