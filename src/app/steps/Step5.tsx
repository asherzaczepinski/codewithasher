  ...
  return (
    <div>
      <ExplanationBox title="What Are Weights?">
        ...
        <p>
          Weights are what determine which pattern each neuron looks for. A high weight on an input means that input strongly influences the total. A near-zero weight means the neuron mostly ignores it. Weights can also be <strong>negative</strong> — meaning that input actively pulls the total down the more it appears.
        </p>
        <p>
          The specific combination of weights across all of a neuron&apos;s inputs is what defines its pattern. Change the weights and you change what the neuron detects entirely — whether that&apos;s humidity-heavy conditions, warm-and-wet combos, or anything else.
        </p>
      </ExplanationBox>
